...
// Forwards its ref to the underlying element - required for this Button to
// work as the `render` target of Base UI components that need to measure or
// focus their trigger (Tooltip, Menu, etc.); without it React warns and the
// trigger's positioning/focus handling silently breaks.
